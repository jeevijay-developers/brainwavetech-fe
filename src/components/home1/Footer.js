import {
  ...
  ourServices,
  otherLinks,
} from "@/constant/home1/footerData";
      ...
      <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-4 col-sm-6 d-lg-flex justify-content-center pt-4">
                <div className="footer-widget">
                  <h5 className="footer-widget-title text-bright-gray">
                    Our links
                  </h5>
                  ...
                  <ul className="footer-links">
                    {ourServices.length > 0 &&
                      ourServices.map((service) => (
                        <li key={service.id}>
                          <a href={service.uri}>{service.txt}</a>
                        </li>
                      ))}
                  </ul>
                </div>
        ...
        <div className="row">
          <div className="col-md-6 pt-3">
            <a href="#" className="footer-terms-text">
              Terms & condition
            </a>
          </div>
          <div className="col-md-6 pt-3">
            <p className="footer-right-text text-md-end">
              All Right Reserved @<a href="#">wprealizer</a>{" "}
            </p>
          </div>
        </div>
      </div>
