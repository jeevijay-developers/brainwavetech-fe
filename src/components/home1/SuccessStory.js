...
export default function SuccessStory({ spaceTopXl = true, spaceBottomXl }) {
    ...
    return (
        <div className={`testimonial-style-one position-relative ${spaceTopXl ? 'section-gap-xl-top' : ''} ${spaceBottomXl ? 'section-gap-bottom-y-1' : ''}`} >
                            ...
                            >
                                <div>
                                    <div className="testimonial-card-style-one">
                                        <p>Frontegg dramatically sped our go-to-market by cutting our up-front
                                            development time</p>

                                        <div className="testimonial-bottom">
                                            <h5 className="text-bright-gray">Jhon Kelaven</h5>
                                ...
                                <div>
                                    <div className="testimonial-card-style-one">
                                        ...
                                        <div className="testimonial-bottom">
                                            <h5 className="text-bright-gray">Jahid Hassan</h5>
                                            <span>Creative designer</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div className="testimonial-thumb-style">
                                            <div className="thumb-avater1">
                                                <img src="/images/shapes/testimonial-avater-xl.png" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="testimonial-thumb-style">
                                            <div className="thumb-avater1">
                                                <img src="/images/shapes/testimonial-avater-xl2.png" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </Slider>
