  ...
  return (
    ...
    <>
      <div className="preview-hero-area position-relative overflow-hidden">
        ...
        <img
          src="/images/shape-wave.svg"
          alt=""
          className="position-absolute top-0 start-0 wow fadeInDown"
          data-wow-delay="0.5s"
        />
        <img src="/images/corner-circle.svg" alt="" className="corner-circle" />
        <div className="preview-screens">
          <img
            src="/images/02_Home.png"
            alt=""
            className="screen-1 single-screen"
          />
          <img
            src="/images/01_Home.png"
            alt=""
            className="screen-2 single-screen wow fadeInUp"
            data-wow-delay="0.3s"
          />
          <img
            src="/images/03_Home.png"
            alt=""
            className="screen-3 single-screen wow fadeInUp"
            data-wow-delay="0.3s"
          />
          <img
            src="/images/05_Services.png"
            alt=""
            className="screen-4 wow fadeInRight single-screen"
            data-wow-delay="0.7s"
          />
          <img
            src="/images/service-details.png"
            alt=""
            className="screen-5 single-screen wow fadeInLeft"
            data-wow-delay="0.7s"
          />
        </div>
            ...
            <div className=" col-xl-8 col-lg-10">
              <div className="preview-hero-contant">
                <a href="#" className="logo">
                  <img src="/images/logo-v2.svg" alt="" />
                </a>
                <h2 className="hero-title pb-4">
                  <span className="position-relative">
                    Powerful{" "}
                    <img
                      src="/images/text-cuntom-underline.svg"
                      alt=""
                      className="position-absolute start-0 bottom-0"
                    />
                  </span>{" "}
                  Responsive SaaS, Startup & Software Template.
                </h2>

                <div className="hero-btns d-flex  justify-content-center mt-5 flex-wrap">
                  <a href="#demo" className="btn-fill-rounded">
                    View Demos
                  </a>
                  <a href="#" className="btn-fill-rounded">
                    Buy Saasto
                  </a>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row pb-60">
            <div className="col-lg-12">
              <h3 className="section-title">
                Explore <span>stunning</span> demos
              </h3>
            </div>
          </div>
          ...
          <div className="row gy-4">
            <div className="col-lg-4 col-md-6 wow fadeInUp">
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/home1" target="_blank">
                    <img src="/images/pages/home-one.png" alt="" />
                  </a>
                </div>
            ...
            <div className="col-lg-4 col-md-6 wow fadeInUp">
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/home2" target="_blank">
                    <img src="/images/pages/home-two.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
            ...
            <div className="col-lg-4 col-md-6 wow fadeInUp">
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/home3" target="_blank">
                    <img src="/images/pages/home-three.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
              ...
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/service" target="_blank">
                    <img src="/images/pages/service.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
            ...
            >
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/service-details" target="_blank">
                    <img src="/images/pages/service-details.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
              ...
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/blog" target="_blank">
                    <img src="/images/pages/blog.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
              ...
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/blog-details" target="_blank">
                    <img src="/images/pages/blog-details.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
              ...
              <div className="demo-box">
                <div className="demo-img-wrap">
                  <a href="/contact" target="_blank">
                    <img src="/images/pages/contact.png" alt="" />
                  </a>
                </div>
                <div className="demo-content">
                  <h3>
      ...
      <div className="features-area ">
        <div className="container">
          <div className="row pb-60">
            <div className="col-lg-12">
              <h3 className="section-title">
                Agencico <span>Core</span> Features
              </h3>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-0">
              <div className="footer-content text-center">
                <h3 className="text-white section-title">
                  Feeling in love? Purchase <span>Saasto</span>
                </h3>
                <div className="footer-btn-wrap pt-5">
                  <a href="#" className="btn-fill-rounded">
                    <img
                      src="/images/envato-logo.svg"
                      alt=""
                      className="img-fluid"
                    />{" "}
